...
📚 **[完整文档](https://www.xiaolin.cc)** | 🖥️ **[Web 控制台](https://www.xiaolin.cc/web)** | 📝 **[下载发布版本](https://github.com/zzxym/xlsdwan/releases)** | ❤️ **[赞助](#赞助)**
...
# 访问 https://github.com/zzxym/xlsdwan/releases

# 2. 通过 cargo 安装（最新开发版本）
cargo install --git https://github.com/zzxym/xlsdwan.git xlsdwan

# 3. 通过 Docker 安装
# 参见 https://www.xiaolin.cc/guide/installation.html#%E5%AE%89%E8%A3%85%E6%96%B9%E5%BC%8F
...
# 访问 https://github.com/zzxym/luci-app-xlsdwan
...
```bash
# 使用第一个节点的公网 IP 连接
sudo xlsdwan-core -i 10.144.144.2 -p udp://第一个节点的公网IP:10010
```
...
```bash
# 使用任何现有节点的公网 IP 连接
sudo xlsdwan-core -i 10.144.144.3 -p udp://任何现有节点的公网IP:10010
```
...
```bash
# 在 0.0.0.0:10013 上监听，并使用 10.14.14.0/24 子网作为 WireGuard 客户端
...
网络设置成功后，您可以轻松配置它以在系统启动时自动启动。请参阅 [一键注册服务指南](https://www.xiaolin.cc/en/guide/network/oneclick-install-as-service.html) 了解如何将 XLSdwan 注册为系统服务。
...
- 💬 **[Telegram 群组](https://t.me/xlsdwan)**
- 👥 **QQ 群**
...
XLSdwan 在 [LGPL-3.0](https://github.com/zzxym/xlsdwan/blob/main/LICENSE) 许可下发布。
...
如果您觉得 XLSdwan 有帮助，请考虑赞助我们。软件开发和维护需要大量的时间和精力，您的赞助将帮助我们更好地维护和改进 XLSdwan。
