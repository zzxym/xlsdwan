...
impl WindowsBuild {
    ...
    pub fn check_for_win() {
        ...
        if target.contains("x86_64") {
            println!("cargo:rustc-link-search=native=xlsdwan/third_party/");
        } else if target.contains("i686") {
            println!("cargo:rustc-link-search=native=xlsdwan/third_party/i686/");
        } else if target.contains("aarch64") {
            println!("cargo:rustc-link-search=native=xlsdwan/third_party/arm64/");
        }
