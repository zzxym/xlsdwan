...
pub mod tests {
    ...
    fn test_stun_servers_config() {
        ...
        let custom_servers = vec!["txt:sdwan.xiaolin.cc".to_string()];
...
stun_servers = [
    ...
    "txt:sdwan.xiaolin.cc"
        ...
        assert_eq!(stun_servers[2], "txt:sdwan.xiaolin.cc");
    }
...
[[peer]]
uri = "udp://192.168.40.33:11010"

[[proxy_network]]
cidr = "10.250.225.0/24"
allow = ["tcp", "udp", "icmp"]
...
"#;
        ...
        let ret = ret.unwrap();
        assert_eq!("10.250.250.10/24", ret.get_ipv4().unwrap().to_string());
        ...
        assert_eq!(
            vec![PortForwardConfig {
                ...
                dst_addr: "192.168.40.33:11011".parse().unwrap(),
                proto: "tcp".to_string(),
            }],
